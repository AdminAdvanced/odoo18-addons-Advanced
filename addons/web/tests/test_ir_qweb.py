...
class TestIrQweb(TransactionCase):
    def test_image_field(self):
        ...
        partner = self.env["res.partner"].create({
            ...
            "image_128": "iVBORw0KGgoAAAANSUhEUgAAAAIAAAACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXwMDAxAAGgAAAAP//D+IBWx9K7TUAAAAASUVORK5CYII=",
        })
    ...
    def test_image_field_webp(self):
        ...
        jpeg_attach = self.env["ir.attachment"].create({
            ...
            "datas": "iVBORw0KGgoAAAANSUhEUgAAAAIAAAACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXwMDAxAAGgAAAAP//D+IBWx9K7TUAAAAASUVORK5CYII="
        })
