    ...
    QUnit.test('Correct border attributes for outlook', async function (assert) {
        ...
        styleSheet.insertRule(`
            .test-border-background {
                background-image: url("data:image/gif;base64,R0lGODlhAQABAAAAACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX==");
            }
        `, 2);
        ...
        convertInline.classToStyle($editable, convertInline.getCSSRules($editable[0].ownerDocument));
        assert.strictEqual($editable.html(),
            `<div class="test-border-zero test-border-background" style="border-style:none;box-sizing:border-box;background-image:url(&quot;data:image/gif;base64,R0lGODlhAQABAAAAACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX==&quot;);border-top-width:0px;border-right-width:0px;border-left-width:0px;border-bottom-width:0px;"></div>`,
