...
class TestL10nEsEdiVerifactuJson(TestL10nEsEdiVerifactuCommon):
    ...
    def test_huella_generation(self):
        ...
        self.assertEqual(fingerprint, "3C464DAF61ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXFC4CC058073F38F12F60")
        ...
        render_values = {
            ...
            'RegistroAlta': {
                ...
                'Encadenamiento': {
                    'RegistroAnterior': {
                        'Huella': "3C464DAF61ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXFC4CC058073F38F12F60",
                    },
                },
        ...
        fingerprint = self.env['l10n_es_edi_verifactu.document']._fingerprint(render_values)
        self.assertEqual(fingerprint, "177547C0D57ACXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXD6F2E69E3A388F90C68")
